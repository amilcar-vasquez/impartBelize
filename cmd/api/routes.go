...
func (a *app) routes() http.Handler {
	...
	// Education routes (use query params for filtering by teacher_id)
	...
	// Qualification routes (use query params for filtering by teacher_id)
	...
	// Document routes (use query params for filtering by teacher_id)
	...
	// Notification routes (use query params for filtering by user_id)
